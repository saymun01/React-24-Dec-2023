...
const Shop = () => {
  return (
    <div className="pt-20 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
      ...
      <div className="flex mt-10 pb-10 ml-3">
        ...
        <div className="card card-compact w-72 bg-White border-2 border-black shadow-xl ml-4">
          <figure>
            <img
              src="https://static-01.daraz.com.bd/p/5b4e70f0e17662e3ce9bb39c4a58ffb7.jpg_400x400q75-product.jpg_.webp"
              alt="Sarri"
            />
          </figure>
          <div className="card-body">
            <p className="card-title text-black text-base">
              Homel Neckband Bluetooth Headphone Bluetooth 5.0 Wireless Headset
            </p>
            <h2 className="text-[#F90] text-2xl">৳ 909</h2>
            <p className="text-black">
              <span className="strikethrough text-[#0000007a]">৳ 1,699</span>{" "}
              -46%
              <img
                className="Freedelevery"
                src="//laz-img-cdn.alicdn.com/tfs/TB1QTkMXG67gK0jSZFHXXa9jVXa-45-28.png"
      ...
      <div className="flex mt-10 pb-10 ml-3">
        <div className="card card-compact w-72 bg-White border-2 border-black shadow-xl">
          <figure>
            <img
              src="https://static-01.daraz.com.bd/p/bd701f610663cf6cf10cb8fa9174db45.jpg_400x400q75-product.jpg_.webp"
          
            />
          </figure>
          <div className="card-body">
            <p className="card-title text-black text-base">
            Ray Ban polarized sunglasses for man
            </p>
            <h2 className="text-[#F90] text-2xl">৳ 120</h2>
            <p className="text-black">
              <span className="strikethrough text-[#0000007a]">৳ 350</span>{" "}
              -66%
              <img
                className="Freedelevery"
                src="//laz-img-cdn.alicdn.com/tfs/TB1QTkMXG67gK0jSZFHXXa9jVXa-45-28.png"
        ...
        <div className="card card-compact w-72 bg-White border-2 border-black shadow-xl ml-4">
          <figure>
            <img
              src="https://static-01.daraz.com.bd/p/ecd6fda25a5c7875702647fc7faedfab.jpg_400x400q75-product.jpg_.webp"
              
            />
          </figure>
          <div className="card-body">
            <p className="card-title text-black text-base">
            Long-Sleeve T-Shirts Of Red Cotton For Men
            </p>
            <h2 className="text-[#F90] text-2xl">৳ 159</h2>
            <p className="text-black">
              <span className="strikethrough text-[#0000007a]">৳ 350</span>{" "}
              -55%
              <img
